...
public class CursedLaserFriendly : ModProjectile, IShaderProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            Projectile.Center = player.Center + player.DirectionTo(Main.MouseWorld) * 90;
            Rotation = Projectile.Center.DirectionTo(Main.MouseWorld).ToRotation() - MathHelper.PiOver2;
        }
