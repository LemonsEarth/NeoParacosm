...
public class MoonBurst : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (Main.myPlayer == Projectile.owner && closestEnemy != null && AITimer >= 120)
        {
            ...
            AITimer = 0;
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), spawnPos, (closestEnemy.Center - spawnPos).SafeNormalize(Vector2.Zero) * 8, ProjectileType<MoonBurstProjectile>(), Projectile.damage, 2f, Projectile.owner, ai1: 1, ai2: 1);
