...
public class SupremeLightsBaneHeldProj : ModProjectile
{
    int AITimer = 0;
    ...
    {
        if (!SupremeLightsBane.hitNPCs.Contains(target) && SupremeLightsBane.hitNPCs.Count < 6)
        {
            SupremeLightsBane.hitNPCs.Add(target);
        }
    }
    ...
    public override void AI()
    {
        ...
        rotValue = MathHelper.Lerp(rotValue, goalRotation, lerpSpeed * speedBoost * player.GetAttackSpeed(DamageClass.Melee));
