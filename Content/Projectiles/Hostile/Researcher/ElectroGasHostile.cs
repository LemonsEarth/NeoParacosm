...
public class ElectroGasHostile : ModProjectile, IShaderProjectile
{
    ...
    public void DrawProjectile()
    {
        ...
        ShaderData.Shader.Parameters["color"].SetValue(new Vector4(0.5f, 0.8f, 1f, Projectile.Opacity));
        ShaderData.Shader.Parameters["velocity"].SetValue(new Vector2(-Projectile.velocity.X * 0.001f, 0.5f));
