...
public class GiantMeatball : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            LemonUtils.QuickProj(Projectile, Projectile.RandomPos(-8,-8), Vector2.UnitY.RotatedBy(i * MathHelper.PiOver4) * savedSpeed, ProjectileType<LostSoulHostile>(), ai0: LostSoulWaitTime, ai1: LostSoulTimeLeft);
        }
    }
}
