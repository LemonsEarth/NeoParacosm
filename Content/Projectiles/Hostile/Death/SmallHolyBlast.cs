...
public class SmallHolyBlast : PrimProjectile
{
    ...
    public override void AI()
    {
        ...
        Projectile.Center = Projectile.Center + 
                            Projectile.velocity.SafeNormalize(Vector2.Zero).RotatedBy(MathHelper.PiOver2) * MathF.Sin(AITimer / 4) * 2;
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        LemonUtils.DrawGlow(Projectile.Center, Color.White, Projectile.Opacity, Projectile.scale * 0.75f);
        return false;
    }
