...
public class HolyLightningWarningProj : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        LemonUtils.DustCircle(Projectile.Center, 8, 10, DustID.TintableDustLighted, 5f, color: Color.LightYellow);
    }
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        for (int i = 0; i < 1; i++)
        {
            Main.EntitySpriteDraw(ParacosmTextures.GlowBallTexture.Value,
                ...
                null,
                Color.LightYellow * Projectile.Opacity * 0.5f,
                0f,
