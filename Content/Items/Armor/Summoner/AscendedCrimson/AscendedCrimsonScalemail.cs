...
public class AscendedCrimsonScalemail : ModItem
{
    ...
    {
        timer++;
        LemonUtils.DrawAscendedWeaponGlowInInventory(Item, ItemID.CrimsonScalemail, position, scale, frame, spriteBatch, Color.Yellow);
        return false;
    }
    ...
    {
        timer++;
        LemonUtils.DrawAscendedWeaponGlowInWorld(Item, ItemID.CrimsonScalemail, rotation, scale, spriteBatch, Color.Yellow);
        return false;
    }
}
