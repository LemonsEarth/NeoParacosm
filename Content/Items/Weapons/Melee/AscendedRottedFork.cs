...
public class AscendedRottedFork : ModItem
{
    ...
    {
        timer++;
        LemonUtils.DrawAscendedWeaponGlowInInventory(Item, ItemID.TheRottedFork, position, scale, frame, spriteBatch, Color.Yellow);
        return false;
    }
    ...
    {
        timer++;
        LemonUtils.DrawAscendedWeaponGlowInWorld(Item, ItemID.TheRottedFork, rotation, scale, spriteBatch, Color.Yellow);
        return false;
    }
