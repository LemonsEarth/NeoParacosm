...
public class DreadlordRelic : BossRelic
{
    ...
    public override string RelicTextureName => "NeoParacosm/Content/Items/Placeable/Relics/DreadlordRelic";
}

public class DreadlordRelicItem : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.DefaultToPlaceableTile(TileType<DreadlordRelic>(), 0);
