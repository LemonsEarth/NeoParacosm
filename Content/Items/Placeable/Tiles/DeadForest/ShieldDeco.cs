...
public class ShieldDeco : ModTile
{
    ...
    public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        Vector2 drawPos = new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y + 8) + zero;
        spriteBatch.Draw(
            texture,
            drawPos,
            frame,
...
public class ShieldDecoItem : ModItem
{
    public override void SetStaticDefaults()
    {
    ...
    {
        Item.DefaultToPlaceableTile(TileType<ShieldDeco>());
        Item.width = 32;
        Item.height = 26;
    }
}
