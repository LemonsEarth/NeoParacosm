...
public class SpearDeco : ModTile
{
    ...
    public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        Vector2 origin = new Vector2(7, 76);
        Vector2 drawPos = new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y + 16) + zero;
        spriteBatch.Draw(
            texture,
            drawPos,
            frame,
...
public class SpearDecoItem : ModItem
{
    public override void SetStaticDefaults()
    {
    ...
    {
        Item.DefaultToPlaceableTile(TileType<SpearDeco>());
        Item.width = 14;
        Item.height = 54;
    }
}
