...
public class MediumBonePile : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.AnchorBottom = new AnchorData(AnchorType.SolidTile | AnchorType.SolidWithTop | AnchorType.None | AnchorType.Platform, TileObjectData.newTile.Width, 0);
