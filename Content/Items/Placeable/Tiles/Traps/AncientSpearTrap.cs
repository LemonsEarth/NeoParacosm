...
public class AncientSpearTrap : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        AddMapEntry(new Color(132, 126, 103), Language.GetText("MapObject.Trap")); // localized text for "Trap"
    }
    ...
    public override void HitWire(int i, int j)
    {
        ...
        {
            spawnPosition = new Vector2(i * 16 + 8 + 16 * horizontalDirection, j * 16 + 8 + 16 * verticalDirection); // The extra numbers here help center the projectile spawn position if you need to.
            ...
            Projectile.NewProjectile(Wiring.GetProjectileSource(i, j), spawnPosition, new Vector2(horizontalDirection, verticalDirection) * 10f, ProjectileID.SpearTrap, 20, 2f, -1);
        }
    }
}

public class AncientSpearTrapItem : ModItem
{
    public override void SetStaticDefaults()
    {
    ...
    {
        Item.DefaultToPlaceableTile(TileType<AncientSpearTrap>());
        Item.width = 16;
        Item.height = 16;
    }
}
