...
public class AncientSpikeTrap : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        AddMapEntry(new Color(129, 116, 83), Language.GetText("MapObject.Trap")); // localized text for "Trap"
    }
...
public class AncientSpikeTrapItem : ModItem
{
    public override void SetStaticDefaults()
    {
    ...
    {
        Item.DefaultToPlaceableTile(TileType<AncientSpikeTrap>());
        Item.width = 16;
        Item.height = 16;
    }
}
