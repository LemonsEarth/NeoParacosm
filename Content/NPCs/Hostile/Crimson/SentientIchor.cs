...
public class SentientIchor : ModNPC
{
    ...
    public override void OnKill()
    {
        ...
        LemonUtils.DustBurst(6, NPC.Center, DustType<FireDust>(), 5, 5, 0.3f, 0.6f, Color.Gold);
    }
    ...
    public override void AI()
    {
        ...
        if (doExplode)
        {
            ...
            if (ExplodeTimer > 60)
            {
                ...
                LemonUtils.DustBurst(8, NPC.Center, DustType<FireDust>(), 8, 8, 0.5f, 1f, Color.Gold);
                if (LemonUtils.NotClient())
                {
                    Spawn_IchorFlames(NPC.Center, Vector2.UnitY.RotatedByRandom(6.28f), duration: 30, angle: MathHelper.Pi, minSpeed: 8, maxSpeed: 12, iterations: 6);
        ...
        if (NPC.HasValidTarget)
        {
            ...
            if (NPC.DistanceSQ(TargetPos) < 100 * 100)
            {
                ...
                NPC.scale = 1.5f;
                LemonUtils.DustBurst(18, NPC.Center, DustType<FireDust>(), 6, 6, 0.75f, 1.5f, Color.Gold);
                return;
            }
            IdleTimer = 0;
            AttackTimer++;
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        ...
        shader.UseColor(Color.Gold * NPC.Opacity);
    ...
    {
        return (spawnInfo.Player.ZoneCrimson && (NPC.downedBoss3 || Main.hardMode)) ? 0.1f : 0f;
    }

    public override void ModifyNPCLoot(NPCLoot npcLoot)
    {
        npcLoot.Add(ItemDropRule.Common(ItemType<QuichorStaff>(), 15, minimumDropped: 1, maximumDropped: 1));
    }
