...
float4 BigLightningShader(float4 sampleColor : COLOR0, float2 coords : TEXCOORD0, float4 position : SV_Position) : COLOR0
{
...
technique Tech1
{
    pass BigLightningShader
    {
        PixelShader = compile ps_2_0 BigLightningShader();
    }
}