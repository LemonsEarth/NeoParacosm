...
internal class InItemPanel : ItemSlotWrapper
{
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        if (Item == null || Item.IsAir)
        {
            ...
            var ascendableItems = Researcher.AscendableItems.Keys.ToList();
            Main.instance.LoadItem(ascendableItems[index]);
            Texture2D texture = TextureAssets.Item[ascendableItems[index]].Value;
